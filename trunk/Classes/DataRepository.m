...
@synthesize trackItInstanceArray;
...
@synthesize getTrackItInstancesUrlSuffix;
@synthesize getAllMyItemsUrlSuffix;
@synthesize sendContactInfoUrlSuffix;
@synthesize sendReportToTrackItUrlSuffix;
...
-(id) init {
    ...
    if (self != nil) {
		...
		reachabilityHost = [[Reachability reachabilityWithHostName:@"some.website.com"] retain];
		...
		[reachabilityInternet startNotifer];
		...
		[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(hostReachabilityHasChanged:) name:kReachabilityChangedNotification object:nil];
		[reachabilityHost startNotifer];		
		...
		appSettings.usageWarningInterval = 0;
		...
		[urlPrefix retain];	
		getServerSettingsUrlSuffix = @"/some/app/domain/getserversettings.script";
		[getServerSettingsUrlSuffix retain];
		getAppSettingsUrlSuffix = @"/some/app/domain/settings.script";
		...
		getTrackItInstancesUrlSuffix = @"/some/app/domain/iphone.script";
		[getTrackItInstancesUrlSuffix retain];
		getAllMyItemsUrlSuffix = @"/some/app/domain/device.script";
		[getAllMyItemsUrlSuffix retain];
		sendContactInfoUrlSuffix = @"/some/app/domain/contact.script";
		[sendContactInfoUrlSuffix retain];
		sendReportToTrackItUrlSuffix = @"/some/app/domain/input.script";
		[sendReportToTrackItUrlSuffix retain];
		...
		trackItInstanceArray = [[NSMutableArray array] retain];
