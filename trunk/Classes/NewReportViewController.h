...
IBOutlet UIButton					*setReportPhotoButton;	   
IBOutlet UIButton					*setReportTypeButton;
IBOutlet UIButton					*setReportLocationButton;
IBOutlet UIButton					*cancelReportButton;
...
@property (nonatomic,retain) IBOutlet UIButton *setReportPhotoButton;
@property (nonatomic,retain) IBOutlet UIButton *setReportTypeButton;
@property (nonatomic,retain) IBOutlet UIButton *setReportLocationButton;
@property (nonatomic,retain) IBOutlet UIButton *cancelReportButton;
@property (nonatomic,retain) IBOutlet UIButton *submitReportButton;
